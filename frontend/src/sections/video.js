  ...
  return ( <div className="lvl10 parrallax-scene2-end">
              <div className="wrapper">
                <div className="b-video">
                  <div className="b-text">Да, это Краснодарский край и его жемчужина - Анапа. Этот город ассоциируется с релаксом и праздником. Даже городская администрация находится рядом с пляжем</div>
