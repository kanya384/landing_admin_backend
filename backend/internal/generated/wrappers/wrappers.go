...
//go:generate gowrap gen -p ../../services/editable -i Editable -t ./cache -o ../../services/editable/editable_with_cache.go
//go:generate gowrap gen -p ../../services/plans -i Plans -t ./cache -o ../../services/plans/plans_with_cache.go
//go:generate gowrap gen -p ../../services/posters -i Posters -t ./cache -o ../../services/posters/posters_with_cache.go
//go:generate gowrap gen -p ../../services/video -i Video -t ./cache -o ../../services/video/video_with_cache.go
