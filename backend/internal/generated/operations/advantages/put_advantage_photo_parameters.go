...
func NewPutAdvantagePhotoParams() PutAdvantagePhotoParams {

	return PutAdvantagePhotoParams{}
}

// PutAdvantagePhotoParams contains all the bound params for the put advantage photo operation
// typically these are obtained from a http.Request
//
// swagger:parameters PutAdvantagePhoto
type PutAdvantagePhotoParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewPutAdvantagePhotoParams() beforehand.
func (o *PutAdvantagePhotoParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
